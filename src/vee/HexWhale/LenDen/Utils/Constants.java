...
public class Constants {
    ...
    // R.drawable.bp5_crop1, R.drawable.bp5_crop2, R.drawable.bp5_crop3, R.drawable.bp5_crop4,
    // R.drawable.bp5_crop5, R.drawable.bp5_crop6
    // };
    //
    // public static int[] menuImages = {
    // R.drawable.add_items, R.drawable.search, R.drawable.favorites, R.drawable.messages,
    ...
    public static int[] menuImages = {
            R.drawable.add_items, R.drawable.search, R.drawable.favorites, R.drawable.profile, R.drawable.settings
    };
    public static String[] menuText = {
    ...
    public static Class<?>[] menuclass = {
            AddItems.class, Search.class, Favorites.class, Profile.class, Settings.class
    };
